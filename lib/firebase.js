...
if (!admin.apps.length) {
  admin.initializeApp({
    credential: admin.credential.cert({
      projectId: process.env.FIREBASE_PROJECT_ID || "power-lab-suplementos",
      clientEmail: process.env.FIREBASE_CLIENT_EMAIL || "firebase-adminsdk-fbsvc@power-lab-suplementos.iam.gserviceaccount.com",
    ...
    storageBucket: process.env.FIREBASE_STORAGE_BUCKET || "power-lab-suplementos.appspot.com",
  });
}
